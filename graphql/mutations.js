...
`;
export const createV2FlatRecall = /* GraphQL */ `
  mutation CreateV2FlatRecall(
    $input: CreateV2FlatRecallInput!
    $condition: ModelV2FlatRecallConditionInput
  ) {
    createV2FlatRecall(input: $input, condition: $condition) {
      component
      conequence
      make
      manufacturer
...
`;
export const updateV2FlatRecall = /* GraphQL */ `
  mutation UpdateV2FlatRecall(
    $input: UpdateV2FlatRecallInput!
    $condition: ModelV2FlatRecallConditionInput
  ) {
    updateV2FlatRecall(input: $input, condition: $condition) {
      component
      conequence
      make
      manufacturer
...
`;
export const deleteV2FlatRecall = /* GraphQL */ `
  mutation DeleteV2FlatRecall(
    $input: DeleteV2FlatRecallInput!
    $condition: ModelV2FlatRecallConditionInput
  ) {
    deleteV2FlatRecall(input: $input, condition: $condition) {
      component
      conequence
      make
      manufacturer
...
`;
export const createV2FlatRecallCountByType = /* GraphQL */ `
  mutation CreateV2FlatRecallCountByType(
    $input: CreateV2FlatRecallCountByTypeInput!
    $condition: ModelV2FlatRecallCountByTypeConditionInput
  ) {
    createV2FlatRecallCountByType(input: $input, condition: $condition) {
      count
      type
    }
  }
`;
export const updateV2FlatRecallCountByType = /* GraphQL */ `
  mutation UpdateV2FlatRecallCountByType(
    $input: UpdateV2FlatRecallCountByTypeInput!
    $condition: ModelV2FlatRecallCountByTypeConditionInput
  ) {
    updateV2FlatRecallCountByType(input: $input, condition: $condition) {
      count
      type
    }
  }
`;
export const deleteV2FlatRecallCountByType = /* GraphQL */ `
  mutation DeleteV2FlatRecallCountByType(
    $input: DeleteV2FlatRecallCountByTypeInput!
    $condition: ModelV2FlatRecallCountByTypeConditionInput
  ) {
    deleteV2FlatRecallCountByType(input: $input, condition: $condition) {
      count
      type
    }
  }
