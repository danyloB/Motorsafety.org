...
#export AWS_ACCESS_KEY_ID="AKIAWYBOEYTZ5RPJUKGH"
#export AWS_SECRET_ACCESS_KEY="1FU0dwEUU3AL8+ZJEaBjGAZXjLM+FR88qZriB3Eu"
#
#if [ ! -f .env ]; then
#  cp .env.example .env
#fi
...
#
#aws --no-cli-pager s3 sync dist s3://${AWS_BUCKET_NAME} --delete
#
#current_time=$(date +%s)
