<template>
  <div id="main-container" class="main-container">
    <div id="inner-container" class="inner-container">
      <InnerHeader />
      <div id="middle">
        <div class="main-body-term">
          <div class="term-title">
            <h1>WEBSITE TERMS OF USE</h1>
            <h6>VERSION 1.0</h6>
            <h6>LAST REVISED ON: SEPTEMBER, 29, 2020</h6>
          </div>
          <div class="content">
            <p>
              The website located at www.motorsafety.org (the “<strong>Site</strong>”) is a copyrighted work belonging
              to MotorSafety.org
              (“<strong>Company</strong>”, “<strong>us</strong>”, “<strong>our</strong>”, and “<strong>we</strong>”).
            ...
            <p>
              THESE TERMS OF USE (THESE “<strong>TERMS</strong>”) SET FORTH THE LEGALLY BINDING TERMS AND CONDITIONS
              THAT GOVERN YOUR USE OF THE SITE. BY ACCESSING OR USING THE SITE, YOU ARE ACCEPTING THESE TERMS
              (ON BEHALF OF YOURSELF OR THE ENTITY THAT YOU REPRESENT), AND YOU REPRESENT AND WARRANT THAT YOU HAVE
              THE RIGHT, AUTHORITY, AND CAPACITY TO ENTER INTO THESE TERMS (ON BEHALF OF YOURSELF OR THE ENTITY THAT YOU
              REPRESENT).
            ...
            <ul class="ul-term">
              <li>
                <h6>1. ACCOUNTS </h6>
                <ul class="ul-term-item">
                  <li>
                    <strong>1.1 Account Creation.</strong> In order to use certain features of the Site, you must
                    register for an
                    account (“<strong>Account</strong>”) and provide certain information about yourself as prompted by
                    the account
                    registration form. You represent and warrant that: (a) all required registration information you
                    submit is truthful and accurate; (b) you will maintain the accuracy of such information. You may
                    delete your Account at any time, for any reason, by following the instructions on the Site. Company
              ...
              <li>
                ...
                <ul class="ul-term-item">
                  ...
                  <li>
                    <strong>2.2 Certain Restrictions.</strong> The rights granted to you in these Terms are subject to
                    the following
                  ...
                  <li>
                    <strong>2.3 Modification.</strong> Company reserves the right, at any time, to modify, suspend, or
                    discontinue the
                  ...
                  <li>
                    <strong>2.4 No Support or Maintenance.</strong> You acknowledge and agree that Company will have no
                    obligation to
                    provide you with any support or maintenance in connection with the Site.
                  </li>
                  <li>
                    <strong>2.5 Ownership.</strong> You acknowledge that all the intellectual property rights, including
                    copyrights,
                    patents, trade marks, and trade secrets, in the Site and its content are owned by Company or
                    Company’s suppliers. Neither these Terms (nor your access to the Site) transfers to you or any third
                    party any rights, title or interest in or to such intellectual property rights, except for the
                    limited access rights expressly set forth in Section 2.1. Company and its suppliers reserve all
              ...
              <li>
                ...
                <ul class="ul-term-item">
                  <li>
                    <strong>3.1 Exclusions.</strong> You understand that Company has no obligation to indemnify you
                    for any Claim that
                    is based on (i) modification of the Site by any party other than Company; (ii) your use of the Site
                    other than as authorized by this Agreement and the Documentation or in violation of your
                    representations and warranties; (iii) use of the Site by any person other than you who accesses the
                    Site using your username and password; or (iv) your failure to stop using the Site after receiving
                    written notice to do so from Company in order to avoid further infringement or misappropriation
                    (subparts (i)-(iv) are referred to collectively as “<strong>Indemnity Exclusions</strong>”).
                  </li>
                  <li>
                    <strong>3.2 Right to Ameliorate Damages.</strong> If your use of the Site is, or in Company’s
                    reasonable opinion is
                    likely to be, subject to a Claim under Section 1.1, MotorSafety.org may, at its sole option and at
                    no charge to you (and in addition to MotorSafety.org’s indemnity obligation to you in Section 1.1)
                    (i) procure for you the right to continue using the Site; (ii) replace or modify the Site so that it
                    is non-infringing and substantially equivalent in function to the original Site; or (iii) if options
                    (i) and (ii) above are not commercially practicable in MotorSafety.org’s sole determination,
                    MotorSafety.org can terminate this Agreement and all licenses granted hereunder (in which event, you
                    will immediately stop using the Site) and refund the Subscription Fees that you paid which are
                    allocable to the remainder of the then-current Subscription Term.
                  </li>
                  <li>
                    <strong>3.3 Your Indemnification Obligation.</strong> Except to the extent that MotorSafety.org is
                    obliged to
                    indemnify you in Section 1.1 above, you will defend, indemnify and hold MotorSafety.org harmless
                    from and against any claims that may arise out of or be related to or connected with your use or
                    misuse of the Site or the Member Resources (including but not limited to collection, transmission
                    and processing of the Personal Information) or use or misuse of the Site or the Member Resources by
                    any person other than you who accesses the Site or the Member Resources using your username and
                    password (including, without limitation, any Indemnity Exclusion). For purposes of this section, any
                    reference to MotorSafety.org shall include MotorSafety.org’s Affiliates, shareholders, directors,
                    officers, employees, agents and contractors.
                  </li>
                  <li>
                    <strong>3.4 Sole Remedy.</strong> This Section sets forth your sole and exclusive remedies, with
                    respect to claims of
              ...
              <li>
                <h6>4. THIRD-PARTY LINKS & ADS; OTHER USERS</h6>
                <ul>
                  <li>
                    <strong>4.1 Third-Party Links & Ads.</strong> The Site may contain links to third-party websites and
                    services, and/or
                  ...
                  <li>
                    <strong>4.2 Other Users.</strong> Your interactions with other Site users are solely between you and
                    such users. You
                  ...
                  <li>
                    <strong>4.3 Release.</strong> You hereby release and forever discharge the Company (and our
                    officers,
                    employees, agents,
                    ...
                    interactions with, or act or omission of, other Site users or any Third-Party Links & Ads). IF YOU
                    ARE A
                    CALIFORNIA RESIDENT, YOU HEREBY WAIVE CALIFORNIA CIVIL CODE SECTION 1542 IN CONNECTION WITH THE
                    FOREGOING, WHICH STATES: “A GENERAL RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR DOES NOT
                    KNOW
              ...
              <li>
                ...
                <p>
                  ADDIONALLY, COMPANY OBTAINS ITS INFORMATION FROM PUBLC AND OTHER AVAILABLE RECORDS AND DOES NOT
                  WARRANT THE ACCURACY OF THE INFORMATION. IN THE EVENT OF AN INACCURACY, ALL RECOURSE, CLAIMS AND
                  INQUIRIES SHALL BE ADDRESSED SOLELY TO THE ORIGINAL SOURCE(S) OF SUCH INFORMATION.
                </p>
              </li>

              <li>
                <h6>6. ASSUMPTION OF RISK AND WAIVER. </h6>
                <p>
                  You expressly and unconditionally assume any risks and waive any and all claims against
                  MotorSafety.org, regardless the bases upon which such claim(s) may be made, that may be based on,
                  arise in connection with or be related to any of the following acts, circumstances or conditions, and
                  regardless of the source or the cause of the issue including but not limited to failures of
                  third-party sites or applications with which the Site interacts:
                </p>
                <ol>
                  <li>
                    any personal injury to you or anyone else relating to, caused by or connected to any inaccuracy
                    in any recall, information, notice, advice, material or any other communication made available on,
                    through or in connection with the Site (including but not limited to live agents, chats, texts and
                    emails associated with or relating to the Site) (collectively, “Resources”) and/or any delay or
                    failure to include or provide any Resources;
                  </li>
                  <li>
                    any personal injury to you or anyone else relating to, caused by or connected to any activity,
                    service or product depicted, reviewed or advertised on or through the Site (including but not
                    limited to live agents, chats, texts and emails associated with or relating to the Site)
                    (collectively, “Goods & Services”);
                  </li>
                  <li>
                    any damage to property of yours or anyone else’s relating to, caused by or connected to any
                    inaccuracy in any Resources and/or any delay or failure to include or provide any Resources;
                  </li>
                  <li>
                    any damage to property of yours or anyone else’s relating to, caused by or connected to Goods &
                    Services;
                  </li>
                  <li>
                    any unauthorized person uses your username and/or password to access the Site with any result,
                  ...
                  <li>
                    viruses or other malicious software are transferred to your computer or other device by using
                    the Site;
                  </li>
                  <li>
                    bugs, errors or inaccuracies in the Site;
                  </li>
                  <li>
                    third-party content, actions or inactions on or with respect to the Site;
                  </li>
                  <li>
                    a suspension or other action taken with respect to your account by MotorSafety.org; or
                  </li>
                  <li>
                ...
                <p>
                  No waiver by MotorSafety.org of any breach by you of any condition or provision of this Agreement
                  shall be deemed a waiver of any similar or dissimilar provision or condition at the same or any prior
                  or subsequent time, nor shall the failure of or delay by MotorSafety.org in exercising any right,
                  power, or privilege under this Agreement operate as a waiver to preclude any other or further exercise
                  thereof or the exercise of any other such right, power, or privilege.
                </p>
                <p>
                  For purposes of this section, any reference to MotorSafety.org shall include MotorSafety.org’s
                  Affiliates, joint venture associates and the owners, directors, officers, employees, agents,
                  contractors and vendors of each.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  ...
                  LIABILITY TO YOU FOR ANY DAMAGES ARISING FROM OR RELATED TO THIS AGREEMENT (FOR ANY CAUSE WHATSOEVER
                  AND REGARDLESS OF THE FORM OF THE ACTION), WILL AT ALL TIMES BE LIMITED TO A MAXIMUM OF FIFTY US
                  DOLLARS (U.S. $50). THE EXISTENCE OF MORE THAN ONE CLAIM WILL NOT ENLARGE THIS LIMIT. YOU AGREE THAT
              ...
              <li>
                ...
                <p>
                  ...
                  terminate immediately. Company will not have any liability whatsoever to you for any termination of
                  your rights under these Terms, including for termination of your Account. Even after your rights under
              ...
              <li>
                ...
                <ul>
                  <li>
                    <strong>9.1 Changes.</strong> These Terms are subject to occasional revision, and if we make any
                    substantial changes,
                    we may notify you by sending you an e-mail to the last e-mail address you provided to us (if any),
                    and/or by prominently posting notice of the changes on our Site. You are responsible for providing
                    ...
                    above, our dispatch of the e-mail containing such notice will nonetheless constitute effective
                    notice of the changes described in the notice. Any changes to these Terms will be effective upon the
                    earlier of thirty (30) calendar days following our dispatch of an e-mail notice to you (if
                    applicable) or thirty (30) calendar days following our posting of notice of the changes on our Site.
                  ...
                  <li>
                    ...
                    <ol>
                      <li>
                        <i>Applicability of Arbitration Agreement.</i>All claims and disputes (excluding claims for
                      ...
                      <li>
                        ...
                        the Company should be sent to: 740 Turnbridge Rd., Danville, California 94526. After the Notice
                      ...
                      <li>
                        <i>Arbitration Rules.</i> Arbitration shall be initiated through the American Arbitration
                        Association (“AAA”), an established alternative dispute resolution provider (“ADR Provider”)
                        that offers arbitration as set forth in this section. If AAA is not available to arbitrate, the
                        parties shall agree to select an alternative ADR Provider. The rules of the ADR Provider shall
                        govern all aspects of the arbitration, including but not limited to the method of initiating
                        and/or demanding arbitration, except to the extent such rules are in conflict with the Terms.
                        The AAA Consumer Arbitration Rules (“Arbitration Rules”) governing the arbitration are available
                        ...
                        award sought is less than Ten Thousand U.S. Dollars (US $10,000.00) may be resolved through
                        binding non-appearance-based arbitration, at the option of the party seeking relief. For claims
                        ...
                        hearing will be held in a location within 100 miles of your residence, unless you reside outside
                      ...
                      <li>
                        <i>Additional Rules for Non-Appearance Based Arbitration.</i> If non-appearance based
                        arbitration
                      ...
                      <li>
                        <i>Time Limits.</i> If you or the Company pursue arbitration, the arbitration action must be
                      ...
                      <li>
                        <i>Authority of Arbitrator.</i> If arbitration is initiated, the arbitrator will decide the
                        rights
                        and liabilities, if any, of you and the Company, and the dispute will not be consolidated with
                      ...
                      <li>
                        <i>Waiver of Jury Trial.</i> THE PARTIES HEREBY WAIVE THEIR CONSTITUTIONAL AND STATUTORY RIGHTS
                        TO
                      ...
                      <li>
                        <i>Waiver of Class or Consolidated Actions.</i> ALL CLAIMS AND DISPUTES WITHIN THE SCOPE OF THIS
                      ...
                      <li>
                        <i>Confidentiality.</i> All aspects of the arbitration proceeding, including but not limited to
                        the
                      ...
                      <li>
                        <i>Severability.</i> If any part or parts of this Arbitration Agreement are found under the law
                        to
                      ...
                      <li>
                        <i>Right to Waive.</i> Any or all of the rights and limitations set forth in this Arbitration
                      ...
                      <li>
                        <i>Survival of Agreement.</i> This Arbitration Agreement will survive the termination of your
                        relationship with Company.
                      </li>
                      <li>
                        <i>Small Claims Court.</i> Notwithstanding the foregoing, either you or the Company may bring an
                      ...
                      <li>
                        <i>Claims Not Subject to Arbitration.</i> Notwithstanding the foregoing, claims of defamation,
                      ...
                      <li>
                        ...
                        parties
                        to litigate in court, the parties hereby agree to submit to the personal jurisdiction of the
                        courts located within Contra Costa County, California, for such purpose
                      </li>
                    </ol>
                  </li>
                  <li>
                    <strong>9.3 Export.</strong> The Site may be subject to U.S. export control laws and may be subject
                    to export or
                  ...
                  <li>
                    <strong> 9.4 Disclosures.</strong> Company is located at the address in Section 8.8. If you are a
                    California resident,
                  ...
                  <li>
                    <strong>9.5 Electronic Communications.</strong> The communications between you and Company use
                    electronic means,
                  ...
                  <li>
                    <strong>9.6 Entire Terms.</strong> These Terms constitute the entire agreement between you and us
                    regarding the use
                  ...
                  <li>
                    <strong>9.7 Copyright/Trademark Information.</strong> Copyright © 2020 MotorSafety.org. All rights
                    reserved. All
                    trademarks, logos and service marks (“Marks”) displayed on the Site are our property or the property
                    of other third parties. You are not permitted to use these Marks without our prior written consent
                    or the consent of such third party which may own the Marks.
                  </li>
                  <li>
                    <strong> 9.8 Contact Information:</strong>
                    <p>MotorSafety.org</p>
                    <p>Address:</p>
                    <p>740 Turnbridge Rd.</p>
                    <p>Danville, California 94526</p>
                    <p>Telephone: (888) 594-5520</p>
                    <p>Email: support@motorsafety.org</p>
                  </li>
                </ul>
              </li>
            </ul>
